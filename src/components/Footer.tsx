    ...
    <footer className="relative bg-[var(--color-foreground)] text-white pt-12 pb-8 overflow-hidden">
      ...
      <div className="max-centered-container px-6 relative z-10 w-full text-center">
        ...
        <div className="flex flex-col items-center text-center space-y-6 mb-6 w-full">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/5 bg-white/5 backdrop-blur-md">
              ...
              <span className="text-[8px] font-black uppercase tracking-[0.4em] text-white/60 italic">Inspiration Mensuelle</span>
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-12 md:gap-24 text-[10px] pt-2 w-full border-b border-white/5 pb-12">
            <div className="space-y-4 min-w-[140px] flex flex-col items-center md:items-start text-center md:text-left">
              <h4 className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/60">Menu</h4>
              <ul className="space-y-3 font-light text-white/70">
                <li><Link href="/expertise" className="hover:text-[var(--color-primary-texte)] transition-colors">Expertise</Link></li>
                <li><Link href="/tarifs" className="hover:text-[var(--color-primary-texte)] transition-colors">Tarifs</Link></li>
                <li><Link href="/realisations" className="hover:text-[var(--color-primary-texte)] transition-colors">Projets</Link></li>
                <li><Link href="/blog" className="hover:text-[var(--color-primary-texte)] transition-colors">Journal</Link></li>
                <li><Link href="/a-propos" className="hover:text-[var(--color-primary-texte)] transition-colors">L'Atelier</Link></li>
                <li><Link href="/contact" className="hover:text-[var(--color-primary-texte)] transition-colors">Contact</Link></li>
              </ul>
            </div>
            <div className="space-y-4 min-w-[140px] flex flex-col items-center md:items-start text-center md:text-left">
              <h4 className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/60">Social</h4>
            ...
            <div className="space-y-4 min-w-[140px] flex flex-col items-center md:items-start text-center md:text-left">
              <h4 className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/60">Légal</h4>
              <ul className="space-y-3 font-light text-white/70">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 w-full">
          <p className="text-white/60 text-[9px] font-light uppercase tracking-[0.4em]">
            Architectures numériques de prestige.
          </p>

          <div className="flex flex-col items-center md:items-end space-y-1">
            <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/60">© 2026 CANEVAS HAVANE.</div>
            <div className="text-[8px] font-light text-white/60 tracking-[0.4em] uppercase">Forging digital legacies</div>
          </div>
        </div>
      </div>
    </footer>
