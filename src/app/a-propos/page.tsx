      ...
      <div className="max-centered-container px-6">
        ...
        <div className="text-center space-y-8 mb-24 md:mb-48">
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-[var(--color-foreground)]/5 bg-white/40 backdrop-blur-md">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-[var(--color-foreground)]/70 italic">L'Esprit de l'Atelier</span>
          </div>

          <h1 className="heading-display">
            <span className="block opacity-60">NOTRE QUÊTE DE</span>
        ...
        <div className="space-y-24 md:space-y-48 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-32 items-center">
            <div className="space-y-6 md:space-y-10 order-2 lg:order-1">
              <h4 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">L'Artisanat Digital</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            <div className="order-2 lg:order-2 space-y-10">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">Notre Vision</h4>
              <h2 className="text-4xl md:text-6xl font-medium uppercase tracking-tight leading-none font-serif">
                CONSTRUIRE DES <br />
                <span className="opacity-60 italic">HÉRITAGES.</span>
              </h2>
        ...
        <div className="text-center space-y-10 md:space-y-12 mb-24 md:mb-48 max-w-2xl mx-auto">
           <h3 className="text-[10px] md:text-xs font-black uppercase tracking-[0.4em] md:tracking-[0.5em] text-[var(--color-foreground)]/70">La Signature</h3>
            <p className="text-xl md:text-2xl font-light italic text-[var(--color-foreground)]/70 leading-relaxed font-serif px-6">
