      ...
      <div className="max-centered-container px-6">
        ...
        <div className="text-center space-y-8 mb-24 md:mb-48">
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-[var(--color-foreground)]/5 bg-white/40 backdrop-blur-md">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-[var(--color-foreground)]/70 italic">Maîtrise & Savoir-faire</span>
          </div>
              ...
              <div className="flex-1 space-y-8 order-2 lg:order-none">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 pt-4 px-6 lg:px-0">
                  {service.items.map((item) => (
                    <li key={item} className="flex items-center gap-3 text-[10px] md:text-xs font-black uppercase tracking-widest text-[var(--color-foreground)]/70">
        ...
        <div className="glass-card p-10 md:p-24 text-center space-y-10 md:space-y-12 w-full rounded-[3rem] md:rounded-[4rem]" style={{ marginBottom: '0px', marginTop: '64px md:100px' }}>
          {/* `text-white` sur une glass-card, qui est transparente à 98 % au-dessus du
              beige : le titre était blanc sur beige, 1,13:1. Illisible. */}
          <h2 className="text-3xl md:text-5xl font-medium uppercase tracking-tight leading-[1.1] md:leading-none text-[var(--color-foreground)] font-serif px-4">
