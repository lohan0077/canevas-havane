      ...
      <div className="max-centered-container px-6">
        ...
        <div className="text-center space-y-8 md:space-y-12 mb-24 md:mb-48">
          <div className="inline-flex items-center gap-3 px-4 md:px-6 py-2 rounded-full border border-[var(--color-foreground)]/5 bg-white/40 backdrop-blur-md">
            ...
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.4em] md:tracking-[0.5em] text-[var(--color-foreground)]/70 italic">Galerie d'Exceptions</span>
          </div>
            ...
            <div key={project.title} className="group relative flex flex-col space-y-6 md:space-y-8">
              <div className="aspect-[16/11] md:aspect-[16/10] overflow-hidden glass-card relative bg-[var(--color-foreground)]/[0.02] !rounded-[2rem] md:!rounded-[3rem]">
                ...
                <div className="absolute top-6 right-6 md:top-10 md:right-10 z-20 opacity-100 md:opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-0 md:translate-y-2 group-hover:translate-y-0">
                  {/* La pastille était blanche sur blanc translucide, au-dessus d'une
                      carte quasi beige : 1,13:1. On assombrit le fond de la pastille. */}
                  <span className="text-[8px] md:text-[10px] font-black uppercase tracking-widest bg-[var(--color-foreground)]/80 backdrop-blur-2xl px-4 py-1.5 md:px-5 md:py-2 rounded-full border border-white/10 text-white">
              ...
              <div className="flex justify-between items-start pt-2 px-1">
                <div className="space-y-3 md:space-y-4">
                  <h4 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">{project.category}</h4>
                  <h3 className="text-3xl md:text-4xl font-medium uppercase tracking-tight text-[var(--color-foreground)] group-hover:text-[var(--color-primary-texte)] transition-colors duration-500 font-serif">
                    {project.title}
                  </h3>
                  <p className="text-[var(--color-foreground)]/70 font-light text-base md:text-lg max-w-sm leading-relaxed">
                    {project.description}
                  </p>
                </div>
        ...
        <div className="text-center w-full" style={{ paddingTop: '64px', paddingBottom: '0px', marginTop: '100px' }}>
           <p className="text-[11px] font-black uppercase tracking-[0.6em] text-[var(--color-foreground)]/70 mb-16">Plus de 50 projets livrés avec excellence</p>
            <Link href="/contact" className="group flex flex-col items-center gap-10">
              <span className="text-5xl font-light italic text-[var(--color-foreground)]/70 group-hover:text-[var(--color-foreground)] transition-all duration-700 tracking-tight font-serif">Votre projet ici ?</span>
