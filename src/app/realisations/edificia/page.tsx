      ...
      <div className="max-centered-container px-6">
        ...
        <section className="pt-20 md:pt-32 pb-24 md:pb-48 space-y-12 md:space-y-16">
          <div className="inline-flex items-center gap-3 px-4 md:px-6 py-2 rounded-full border border-[var(--color-foreground)]/5 bg-white/5 backdrop-blur-md">
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.4em] md:tracking-[0.5em] text-[var(--color-primary-texte)] italic">Fintech & SaaS</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 md:gap-12">
            <h1 className="heading-display text-left">
              <span className="block opacity-60">PLATEFORME</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 mb-24 md:mb-48 items-start">
          <div className="space-y-10 md:space-y-12">
            <div className="space-y-6">
              <h4 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">La Mission</h4>
            ...
            <div className="grid grid-cols-2 gap-8 md:gap-12 pt-8 border-t border-[var(--color-foreground)]/5">
              ...
              <div className="space-y-2">
                ...
                <a href="https://edificia.fr" target="_blank" rel="noopener noreferrer" className="text-base md:text-lg font-medium uppercase font-serif text-[var(--color-primary-texte)] hover:underline decoration-1 underline-offset-4">edificia.fr</a>
              </div>
            </div>

            {/* Repositioned Piliers Tech - Moved Down */}
            <div className="glass-card p-10 space-y-8 relative overflow-hidden bg-white/[0.02] mt-8">
               <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">Piliers Tech</h4>
        ...
        <section className="mb-48 space-y-24">
            <div className="flex flex-col md:flex-row justify-between items-end gap-8">
                <h2 className="text-5xl md:text-7xl font-medium uppercase tracking-tight font-serif leading-[0.9]">
                   PILOTAGE <br />
                   <span className="opacity-60 italic">ABSOLU.</span>
                </h2>
                <p className="max-w-md text-right text-[var(--color-foreground)]/70 font-light italic">
        ...
        <div className="text-center w-full section-spacer pb-32">
            <Link href="/realisations" className="group flex flex-col items-center gap-10">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[var(--color-foreground)]/70 italic">Explorer l'excellence</span>
              <span className="text-5xl font-light italic text-[var(--color-foreground)] group-hover:text-[var(--color-primary-texte)] transition-all duration-700 tracking-tight font-serif">Retour au Portfolio</span>
