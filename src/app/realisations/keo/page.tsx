      ...
      <div className="max-centered-container px-6">
        ...
        <section className="pt-20 md:pt-32 pb-24 md:pb-48 space-y-12 md:space-y-16">
          <div className="inline-flex items-center gap-3 px-4 md:px-6 py-2 rounded-full border border-[var(--color-foreground)]/5 bg-white/5 backdrop-blur-md">
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.4em] md:tracking-[0.5em] text-[var(--color-primary-texte)] italic">PropTech de Prestige</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 md:gap-12">
            <h1 className="heading-display text-left">
              <span className="block opacity-60">L'ÉCOSYSTÈME</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 mb-24 md:mb-48 items-start">
          <div className="space-y-10 md:space-y-12">
            <div className="space-y-6">
              <h4 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">Le Défi</h4>
            ...
            <p className="text-base md:text-lg text-[var(--color-foreground)]/70 font-light leading-relaxed">
             ...
             <div className="grid grid-cols-2 gap-8 md:gap-12 pt-8 border-t border-[var(--color-foreground)]/5">
              <div className="space-y-2">
                <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] text-[var(--color-foreground)]/70">Client</span>
                <p className="text-base md:text-lg font-medium uppercase font-serif">Kéo Immobilier</p>
              </div>
               <div className="space-y-2">
                <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] text-[var(--color-foreground)]/70">Lien Live</span>
                <a href="https://kéo.fr" target="_blank" rel="noopener noreferrer" className="text-base md:text-lg font-medium uppercase font-serif text-[var(--color-primary-texte)] hover:underline decoration-1 underline-offset-4">kéo.fr</a>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 md:p-16 space-y-10 md:space-y-12 relative overflow-hidden group">
             ...
             <h4 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] text-[var(--color-primary-texte)]">Spécifications</h4>
             <ul className="space-y-6 md:space-y-8">
                <li className="space-y-1 md:space-y-2">
                   ...
                   <p className="text-[13px] md:text-sm font-light text-[var(--color-foreground)]/70 leading-relaxed italic">Réduction du temps de saisie de 40% via une architecture centrée utilisateur.</p>
                </li>
                <li className="space-y-1 md:space-y-2">
                   <h5 className="text-base md:text-lg font-medium font-serif">Intelligence Prédictive</h5>
                   <p className="text-[13px] md:text-sm font-light text-[var(--color-foreground)]/70 leading-relaxed italic">Tableaux de bord dynamiques avec projection de cashflow en temps réel.</p>
                </li>
                <li className="space-y-1 md:space-y-2">
                   <h5 className="text-base md:text-lg font-medium font-serif">Infrastructure Sécurisée</h5>
                   <p className="text-[13px] md:text-sm font-light text-[var(--color-foreground)]/70 leading-relaxed italic">Chiffrement de bout en bout et hébergement souverain haute disponibilité.</p>
                </li>
             </ul>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-48">
            ...
            <div className="flex flex-col justify-center space-y-12 p-8 md:p-16">
                <h3 className="text-4xl font-medium uppercase font-serif">Un pilotage <br /><span className="text-[var(--color-primary-texte)]">sans concession.</span></h3>
                <p className="text-xl font-light text-[var(--color-foreground)]/70 leading-relaxed">
                ...
                <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-full border border-[var(--color-foreground)]/10 flex items-center justify-center text-[var(--color-primary-texte)]">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2v20M2 12h20"/></svg>
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-widest self-center opacity-70 italic">Déploiement Continu</span>
                </div>
            </div>
        </div>
        ...
        <div className="text-center w-full section-spacer pb-16 md:pb-32">
            <Link href="/realisations" className="group flex flex-col items-center gap-6 md:gap-10">
              <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.4em] md:tracking-[0.5em] text-[var(--color-foreground)]/70 italic">Lien vers les autres œuvres</span>
              <span className="text-3xl md:text-5xl font-light italic text-[var(--color-foreground)] group-hover:text-[var(--color-primary-texte)] transition-all duration-700 tracking-tight font-serif px-4">Suite du Portfolio</span>
